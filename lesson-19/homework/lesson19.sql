...
--create table orders (ord_no int, purch_amt decimal(7,2), ord_date date, customer_id int, salesman_id int)
...
--select salesman_id, customer_id, ord_date, purch_amt, ord_no from orders
--select salesman_id from orders

--create table customer ( customer_id int,cust_name varchar(40),city varchar (40),grade int,salesman_id int)
...
--create table noble_win (YEAR int, SUBJECT varchar(40), WINNER  varchar(40), COUNTRY varchar(40), CATEGORY varchar (40));
...
--select  year, subject, winner, country, category from noble_win
