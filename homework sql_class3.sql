--create database homework_sqlclass3

--create table salesman (salesman_id int, [name] varchar(23), city varchar(20), comissio real);
...
--create table customer (customer_id int, cust_name varchar(20), city varchar(20), grade varchar(100), salesman_id int);
...
--create table orders (ord_no int, purch_amt real, ord_date date, customer_id int, salesman_id int) 
...
--create table employees (EMPLOYEE_ID INT, FIRST_NAME VARCHAR(20), LAST_NAME VARCHAR(20),  
--						EMAIL VARCHAR(20), PHONE_NUMBER VARCHAR(24), HIRE_DATE DATE, JOB_ID VARCHAR(17),
--						SALARY REAL, COMMISSION_PCT REAL, MANAGER_ID INT, DEPARTMENT_ID INT);
...
--create table departments ( DEPARTMENT_ID INT, DEPARTMENT_NAME VARCHAR(25), MANAGER_ID INT, LOCATION_ID INT)
...
--create table locations  (LOCATION_ID INT, STREET_ADDRESS VARCHAR(45), POSTAL_CODE VARCHAR(15), CITY VARCHAR(25), STATE_PROVINCE VARCHAR(25), COUNTRY_ID VARCHAR(5));
...
--create table jobs (JOB_ID VARCHAR(15), JOB_TITLE VARCHAR(40), MIN_SALARY VARCHAR(14), MAX_SALARY VARCHAR(14));
...
--create table job_history (EMPLOYEE_ID INT, START_DATE DATE, END_DATE DATE, JOB_ID VARCHAR(20), DEPARTMENT_ID VARCHAR(7));
